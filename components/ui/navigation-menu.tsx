...
>(({ className, ...props }, ref) => (
  <div className={cn("absolute  top-full flex justify-center border ")}>
    <NavigationMenuPrimitive.Viewport
      className={cn(
        "origin-top-center absolute  mt-1.5 h-[var(--radix-navigation-menu-viewport-height)] w-full overflow-hidden rounded-md border bg-popover text-popover-foreground shadow-lg data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-90 w-[70vw] border border-red-500",
        className
      )}
      ref={ref}
      {...props}
